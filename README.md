...
![PIWM-v6 architecture](reports/figures/architecture_v6.png)

> The figure is regenerated by `python reports/draw_architecture_v6.py` (matplotlib only, vector PDF also written).
