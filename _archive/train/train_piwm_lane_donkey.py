"""Train Stage 2 dynamics of PIWM-donkey (no Ackermann, big lane residual).

Same training schedule as PIWM-kin2 — only the model class differs.
Output: checkpoints/piwm_lane_donkey/dyn.tar
"""
...
SAVE_DIR    = "checkpoints/piwm_lane_donkey/"
ROLLOUT_K   = 8
DYN_EPOCHS  = 60
LAMBDA_LANE = 2.0
...
def stage2_dyn():
    ...
    print(f"PIWM-donkey Dyn best: {best:.5f}")
