"""Train Stage 2 of PIWM-donkey-v2 (normalized-space dynamics + lane resample).

Output: checkpoints/piwm_lane_donkey_v2/dyn.tar
"""
...
SAVE_DIR    = "checkpoints/piwm_lane_donkey_v2/"
ROLLOUT_K   = 8
DYN_EPOCHS  = 60
LAMBDA_LANE = 2.0
...
def stage2_dyn():
    ...
    print(f"PIWM-donkey-v2 Dyn best: {best:.5f}")
